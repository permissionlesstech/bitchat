...
/// Media was previously bounded by incoming quota only, so sent and received
/// payloads could remain on disk indefinitely. These cover the age-based sweep
/// that bounds it in time as well.
