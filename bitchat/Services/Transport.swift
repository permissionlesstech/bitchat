...
protocol Transport: AnyObject {
    ...
    // Double-ratchet bootstrap exchanged out of band over authenticated Noise.
    func sendNdrEvent(
        to peerID: PeerID,
        eventJson: String,
    ...
    /// Capabilities and static identity authenticated by the exact current
    /// Noise generation. Nil while proof is absent, stale, or rekeying.
