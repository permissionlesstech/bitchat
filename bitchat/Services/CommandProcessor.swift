...
final class CommandProcessor {
    ...
    func process(_ command: String) -> CommandResult {
        ...
        guard let cmd = parts.first else { return .error(message: String(localized: "error.invalid_command")) }
        ...
        case "/clear":
            return handleClear()
        case "/hug":
            return handleEmote(args, command: "hug", action: String(localized: "command.emote.hugs"), emoji: "🫂")
        case "/slap":
            return handleEmote(args, command: "slap", action: String(localized: "command.emote.slaps"), emoji: "🐟", suffix: String(localized: "command.emote.slap_suffix"))
        case "/block":
            return handleBlock(args)
        case "/unblock":
            return handleUnblock(args)
        case "/fav":
            if inGeoPublic || inGeoDM { return .error(message: String(localized: "command.error.favorites_mesh_only")) }
        ...
        case "/help", "/h":
            return handleHelp()
        default:
            return .error(message: String.localizedStringWithFormat(String(localized: "command.error.unknown"), String(cmd)))
        }
    }
    ...
    private func handleMessage(_ args: String) -> CommandResult {
        ...
        guard !parts.isEmpty else {
            return .error(message: String(localized: "command.usage.msg"))
        }
        ...
        guard let peerID = chatViewModel?.getPeerIDForNickname(nickname) else {
            return .error(message: String.localizedStringWithFormat(String(localized: "command.error.user_not_found"), nickname))
        }
        ...
        return .success(message: String.localizedStringWithFormat(String(localized: "command.success.private_chat_started"), nickname))
    }
    ...
    private func handleWho() -> CommandResult {
        ...
        case .location(let ch):
            ...
            guard let vm = chatViewModel else { return .success(message: String(localized: "command.success.nobody_around")) }
            ...
            if names.isEmpty { return .success(message: String(localized: "command.success.no_one_online")) }
            return .success(message: String.localizedStringWithFormat(String(localized: "command.success.online_list"), names.sorted().joined(separator: ", ")))
        case .mesh:
            // Mesh context: show connected peer nicknames
            guard let peers = meshService?.getPeerNicknames(), !peers.isEmpty else {
                return .success(message: String(localized: "command.success.no_one_online"))
            }
            let onlineList = peers.values.sorted().joined(separator: ", ")
            return .success(message: String.localizedStringWithFormat(String(localized: "command.success.online_list"), onlineList))
        }
    }
    ...
    private func handleEmote(_ args: String, command: String, action: String, emoji: String, suffix: String = "") -> CommandResult {
        ...
        guard !targetName.isEmpty else {
            return .error(message: String.localizedStringWithFormat(String(localized: "command.usage.block_unblock"), command))
        }
        ...
        guard let targetPeerID = chatViewModel?.getPeerIDForNickname(nickname),
            ...
            return .error(message: String.localizedStringWithFormat(String(localized: "command.error.cannot_block_unblock"), command, nickname))
        }
    ...
    private func handleBlock(_ args: String) -> CommandResult {
        ...
        if targetName.isEmpty {
            ...
            return .success(message: String.localizedStringWithFormat(String(localized: "command.success.blocked_list"), meshList, geoList))
        }
        ...
        if let peerID = chatViewModel?.getPeerIDForNickname(nickname),
           let fingerprint = meshService?.getFingerprint(for: peerID) {
            if identityManager.isBlocked(fingerprint: fingerprint) {
                return .success(message: String.localizedStringWithFormat(String(localized: "command.success.already_blocked"), nickname))
            }
            ...
            return .success(message: String.localizedStringWithFormat(String(localized: "command.success.blocked_mesh"), nickname))
        }
        ...
        if let pub = chatViewModel?.nostrPubkeyForDisplayName(nickname) {
            ...
            return .success(message: String.localizedStringWithFormat(String(localized: "command.success.blocked_geohash"), nickname))
        }
        
        return .error(message: String.localizedStringWithFormat(String(localized: "command.error.cannot_block"), nickname))
    }
    
    private func handleUnblock(_ args: String) -> CommandResult {
        let targetName = args.trimmingCharacters(in: .whitespaces)
        guard !targetName.isEmpty else {
            return .error(message: String(localized: "command.usage.unblock"))
        }
        ...
        if let peerID = chatViewModel?.getPeerIDForNickname(nickname),
           let fingerprint = meshService?.getFingerprint(for: peerID) {
            if !identityManager.isBlocked(fingerprint: fingerprint) {
                return .success(message: String.localizedStringWithFormat(String(localized: "command.success.not_blocked"), nickname))
            }
            identityManager.setBlocked(fingerprint, isBlocked: false)
            return .success(message: String.localizedStringWithFormat(String(localized: "command.success.unblocked_mesh"), nickname))
        }
        // Try geohash unblock
        if let pub = chatViewModel?.nostrPubkeyForDisplayName(nickname) {
            if !identityManager.isNostrBlocked(pubkeyHexLowercased: pub) {
            ...
            return .success(message: String.localizedStringWithFormat(String(localized: "command.success.unblocked_geohash"), nickname))
        }
        return .error(message: String.localizedStringWithFormat(String(localized: "command.error.cannot_unblock"), nickname))
    }
    
    private func handleFavorite(_ args: String, add: Bool) -> CommandResult {
        let targetName = args.trimmingCharacters(in: .whitespaces)
        guard !targetName.isEmpty else {
            return .error(message: String.localizedStringWithFormat(String(localized: "command.usage.favorite"), add ? "fav" : "unfav"))
        }
        ...
        guard let peerID = chatViewModel?.getPeerIDForNickname(nickname),
            ...
            return .error(message: String.localizedStringWithFormat(String(localized: "command.error.cant_find_peer"), nickname))
        }
        ...
        if add {
            ...
            return .success(message: String.localizedStringWithFormat(String(localized: "command.success.added_favorite"), nickname))
        } else {
            ...
            return .success(message: String.localizedStringWithFormat(String(localized: "command.success.removed_favorite"), nickname))
        }
    }
    ...
    private func handleHelp() -> CommandResult {
        let helpText = """
        commands:
        /msg @name - \(String(localized: "command.help.msg"))
        /who - \(String(localized: "command.help.who"))
        /clear - \(String(localized: "command.help.clear"))
        /hug @name - \(String(localized: "command.help.hug"))
        /slap @name - \(String(localized: "command.help.slap"))
        /fav @name - \(String(localized: "command.help.fav"))
        /unfav @name - \(String(localized: "command.help.unfav"))
        /block @name - \(String(localized: "command.help.block"))
        /unblock @name - \(String(localized: "command.help.unblock"))
        """
