...
echo "  - Identity/           Identity management"
echo "  - Localization/       String catalogs & InfoPlist.strings"
echo "  - Models/             Data models"
echo "  - Noise/              Noise crypto primitives"
echo "  - Nostr/              Nostr integration"
echo "  - Protocols/          BitChat protocol types"
echo "  - Services/           Bluetooth, networking, crypto"
